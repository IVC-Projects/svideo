...
thresh_hei = 600; % threshold patch size for inference, since too big image may cost too much memory  160 262
thresh_wid = 600;
rf = 32;

gain = 0;

fid1 = fopen('/media/tjc/RES/test/rse3/location_txt/merge_s10.txt','rt');   %%1111111111111111111111111111111111  mush be attention!!!
...
test_sequence_data_path = '/media/tjc/RES/test/rse3/test_sequence_data/ai/s10_3392x1984_ai_qp37/';  % this place should change!!!!!!!!!!!!2222222
test_sequence_label_path = '/media/tjc/RES/test/rse3/test_sequence_label/s10_3392x1984_crop/';   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%333333333
...
% weights = ['/media/tjc/RES/model/ai/model_res3/foreground_ai_res3_final/se_res3_qp37_ai_foreground_Filter_iter_132000.caffemodel'];
weights = ['/media/tjc/RES/model/ai/model_res3/foreground_ai_res3_final/se_res3_qp37_ai_foreground_Filter_iter_132000.caffemodel'];
%     weights_foreground = ['/home/jiaby/tjc/tjc/RES/model_res3/frames_ai_res3_final/se_res3_qp37_ai_frames_Filter_iter_255000.caffemodel'];
% if you want to use loop function, set startNUM and endNUM, if
% startNUM == endNUM, this forloop just run once.(tjc, 2018/10/05)
%    weights_foreground =
%    ['/home/jiaby/tjc/tjc/RES/model_res3/se_res3_qp37_ai_frames_Filter_iter_',num2str(epochNUM),'.caffemodel'];%
%
model_path = '/media/tjc/RES/test/rse3/DSE_TJC_res3_Final_test';
