...
fid1 = fopen('/media/tjc/RSE/test/rse3/location_txt/merge_s17.txt','rt');   %%1111111111111111111111111111111111  mush be attention!!!
...
test_sequence_data_path = '/media/tjc/RSE/test/rse3/test_sequence_data/qp42/rb/s17_1920x1024_rb_qp42/';  % this place should change!!!!!!!!!!!!2222222
test_sequence_label_path = '/media/tjc/RSE/test/rse3/test_sequence_label/s17_1920x1024_gt/';   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%333333333
...
%
model_path = '/media/tjc/RSE/test/rse3/DSE_TJC_res3_Final_test';
...
for iii = 1:1:length(dData)
    ...
    weights_ai = ['/media/tjc/RSE/model/qp42/ai/res3_ai_fore/res3_qp42_ai_fore_Filter_iter_90000.caffemodel'];
    weights_rb = ['/media/tjc/RSE/model/qp42/rb/fore_rrb_fore_2/res3_qp42_rrb_fore_Filter_iter_45000.caffemodel'];
%     weights_ldp = ['/media/tjc/RSE/model/ldp/VDSR/VDSR_qp37_ldp_foreground_Filter_iter_18000.caffemodel'];
    ...
    for x = 1 : hei_stride : hei
        for y = 1 : wid_stride : wid
            ...
            if iii == 1 || iii == 33
                ...
                subim_output = do_cnn(model,weights_rb,data);
            end;
    ...
    hei = temp_end;
    for k = 1 : s(1)
        txt_x1 = round(str2double(cell(k, 2))) + 1;  % 锟角凤拷要锟斤拷1
        if txt_x1 > wid
            txt_x1 = wid;
        end;
